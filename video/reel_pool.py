...
아니라 장소 소개고, 장소 소개를 보고 들어오는 사람은 없다.
    ...
    가운데  튜브 · 계단 · DJ. 노는 사람이 계속 나온다
    끝      전망 한 컷. 다음 판(행사 정보)이 얹힐 자리라 여기만 조용하다
...
CUTS = [
    ('P1023235',  1.6, 3, 0.50, 1.05, '풀 가득 · 튜브 (훅 — 사람이 많다)'),
    ('P1023237',  2.0, 2, 0.48, 1.06, '풀 안 사람들'),
    ('P1023231',  9.3, 2, 0.50, 1.06, '풀에 사람 가득'),
    ('P1023239',  9.2, 3, 0.50, 1.05, 'DJ — 믹서 위의 손'),
    ('P1023237',  4.0, 2, 0.50, 1.06, '튜브 탄 사람들'),
    ('P1023235',  3.4, 2, 0.50, 1.05, '풀 사람들'),
    ('P1023236', 19.0, 2, 0.50, 1.06, '계단 · 사람들'),
    ('P1023237',  6.0, 2, 0.52, 1.05, '계단에 사람들'),
    ('P1023239',  1.8, 3, 0.44, 1.04, 'DJ'),
    ('P1023235',  5.1, 2, 0.50, 1.05, '풀 + 튜브'),
    ('P1023234', 25.8, 3, 0.52, 1.06, '핑크 LED + 풀'),
    ('P1023234', 30.6, 3, 0.50, 1.05, '도시 전망 — 정보가 얹힐 자리'),
]
