...
CUTS = [
    ...
    ('P1023231',  9.0, 5, 0.50, 1.06, '풀에 사람 가득'),
    # 4.0 에서 시작하면 컷 끝이 계단·잔디로 넘어가 물이 사라진다
    ('P1023237',  3.2, 4, 0.50, 1.06, '튜브 탄 사람들'),
    ('P1023235',  4.6, 5, 0.50, 1.05, '풀 + 튜브'),
    ('P1023239',  8.8, 4, 0.50, 1.05, 'DJ — 물 아닌 유일한 컷'),
    ('P1023231', 11.2, 5, 0.50, 1.06, '풀 사람들'),
    ('P1023234',  5.0, 6, 0.50, 1.05, '위에서 본 풀 — 정보가 얹힐 자리'),
]
