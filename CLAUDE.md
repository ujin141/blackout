...
python feed_ring.py                           #   같은 3연작 다른 디자인 — 관통선 + 원. 릴스 커버도 같이 나온다
...
python feed_b2b.py                            # 백투백 피드 3연작 — 가운데 타이틀, 양쪽이 마주 본다
...
python cover_reels.py first                   #   먼저 나간 세 편(lineup·sunset·pool)용 세트
